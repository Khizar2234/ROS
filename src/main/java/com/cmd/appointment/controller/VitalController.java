...
public class VitalController {
	...
	@GetMapping("/ViewVitals/{aid}")
	@Operation(summary = "To view all Vital")
	public ResponseEntity<?> getVitals(@RequestParam(value = "appointment_id") long appointment_id) {
		ResponseEntity<?> response = null;
		try {
			response = new ResponseEntity<>(vitService.viewVitalByAppId(appointment_id), HttpStatus.OK);
